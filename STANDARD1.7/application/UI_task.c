...
extern int8_t R,QA,EA,turn_flags,sharp_angle;
extern int8_t CBLOOD;
extern int8_t FCHO;
extern int8_t GR;
Graph_Data Aim[11];
String_Data strSHOOT,strCAP,strPILL,strMODE,strBLOOD,strSUPREME,strDANCANG;
