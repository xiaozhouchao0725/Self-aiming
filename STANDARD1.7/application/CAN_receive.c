...
/*
µç»úÊı¾İ, 0:µ×ÅÌµç»ú1 3508µç»ú,  1:µ×ÅÌµç»ú2 3508µç»ú,2:µ×ÅÌµç»ú3 3508µç»ú,3:µ×ÅÌµç»ú 4 3508µç»ú;
...
void CAN_cmd_cap(int16_t temPower)//³¬¼¶µçÈİ
{
    uint32_t send_mail_box;
...
/**
  * @brief          ·µ»ØÄ¦²ÁÂÖ 3508µç»úÊı¾İÖ¸Õë
  * @param[in]      none
  * @retval         µç»úÊı¾İÖ¸Õë
  */
